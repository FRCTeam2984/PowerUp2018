...
import org.ljrobotics.frc2018.paths.CenterRightScaleFast;
import org.ljrobotics.frc2018.paths.RightScaleToSwitch;
import org.ljrobotics.frc2018.subsystems.Arm;
import org.ljrobotics.lib.util.control.PathContainer;

import edu.wpi.first.wpilibj.command.CommandGroup;

public class TwoCubeCenterRight extends CommandGroup{

	public TwoCubeCenterRight() {
		PathContainer path = new CenterRightScaleFast();
		...
		PathContainer toTheSwitch = new RightScaleToSwitch();
