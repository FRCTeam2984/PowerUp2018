...
public class CANTalonFactory {
    ...
    public static CANTalon updatePermanentSlaveTalon(CANTalon talon, int master_id) {
    	updateCANTalon(talon, kSlaveConfiguration);
        talon.changeControlMode(TalonControlMode.Follower);
        talon.set(master_id);
        return talon;
    }
    ...
    public static void updateCANTalon(CANTalon talon, Configuration config) {
	...
	public static void updateCANTalonToDefault(CANTalon talon) {
		updateCANTalon(talon, kDefaultConfiguration);
	}
